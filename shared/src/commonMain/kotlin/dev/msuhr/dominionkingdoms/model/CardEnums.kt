...
/**
 * Editions of an expansion. [imageName] is the drawable/asset base name -
 * resolve it to a platform image on the platform side (R.drawable on Android,
 * asset/image lookup on iOS).
 */
@Serializable(with = SetSerializer::class)
enum class Set (val imageName: String = "", val displayName: String = "") {
    BASE_1E("set_dominion_1e", "Dominion"),
    BASE_2E("set_dominion_2e", "Dominion"),
    INTRIGUE_1E("set_intrigue_1e", "Intrigue"),
    INTRIGUE_2E("set_intrigue_2e", "Intrigue"),
    SEASIDE_1E("set_seaside_1e", "Seaside"),
    SEASIDE_2E("set_seaside_2e", "Seaside"),
    ALCHEMY("set_alchemy", "Alchemy"),
    PROSPERITY_1E("set_prosperity_1e", "Prosperity"),
    PROSPERITY_2E("set_prosperity_2e", "Prosperity"),
    CORNUCOPIA_1E("set_cornucopia", "Cornucopia"),
    CORNUCOPIA_GUILDS_2E("set_cornucopia_guilds_2e", "Cornucopia"),
    HINTERLANDS_1E("set_hinterlands_1e", "Hinterlands"),
    HINTERLANDS_2E("set_hinterlands_2e", "Hinterlands"),
    DARK_AGES("set_dark_ages", "Dark Ages"),
    GUILDS_1E("set_guilds", "Guilds"),
    ADVENTURES("set_adventures", "Adventures"),
    EMPIRES("set_empires", "Empires"),
    NOCTURNE("set_nocturne", "Nocturne"),
    RENAISSANCE("set_renaissance", "Renaissance"),
    MENAGERIE("set_menagerie", "Menagerie"),
    ALLIES("set_allies", "Allies"),
    PLUNDER("set_plunder", "Plunder"),
    RISING_SUN("set_rising_sun", "Rising Sun"),
    PROMO("set_promo", "Promo Cards")
}
